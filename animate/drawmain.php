...
<div class="container">
  ...
  <g class = "g-ants">
    ...
    <form method="post" action="sys/executemain.php">
    <input type="text" value="<?php echo $code?>" id="id" class="hidden">
    <input type="text" value="<?php echo $prize?>" name="prize" class="hidden">
...
<div class="container">
  ...
  <g class = "g-ants">
    ...
    <div class="row" align="center">
    <form method="post" action="sys/e2.php">
    <input type="text" value="<?php echo $code?>" id="id" class="hidden">
    <input type="text" value="<?php echo $prize?>" name="prize" class="hidden">
    <input type="text" name="code"  id="code" required="">
    <br>  <br>
...
<div class="container">
  ...
  <g class = "g-ants">
    ...
    <div class="row" align="center">
    <form method="post" action="sys/e3.php">
    <input type="text" value="<?php echo $code?>" id="id" class="hidden">
    <input type="text" value="<?php echo $prize?>" name="prize" class="hidden">
    <input type="text" name="code"  id="code" required="">
    <br>  <br>
...
<div class="container">
  ...
  <g class = "g-ants">
    ...
    <div class="row" align="center">
    <form method="post" action="sys/e4.php">
    <input type="text" value="<?php echo $code?>" id="id" class="hidden">
    <input type="text" value="<?php echo $prize?>" name="prize" class="hidden">
    <input type="text" name="code"  id="code" required="">
    <br>  <br>
