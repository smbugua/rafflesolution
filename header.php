...
<html lang="en">
<head>
<title>Galleria Draw Solution</title>
<meta charset="UTF-8" />
...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li class="submenu"> <a href="#"><i class="icon icon-user"></i> <span>Customer</span> <span class="label label-important"></span></a>
      <ul>
        <li><a href="customers.php">Customers Lists</a></li>
      </ul>
    </li>
    <li class="submenu"> <a href="#"><i class="icon icon-glass"></i> <span>Draw Entries</span> <span class="label label-important"></span></a>
      <ul>
        <li><a href="entries.php">Draw Entries</a></li>
        <!--li><a href="recallls.php">Recalls</a></li-->
      </ul>
    </li>
   <li class="submenu"> <a href="#"><i class="icon icon-money"></i> <span>Winners</span> <span class="label label-important"></span></a>
      <ul>
        <li><a href="winners.php">Winner List</a></li>
      </ul>
    </li>
